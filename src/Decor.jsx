...
import data from './assets/js/decor'; // Your decor data source
      ...
      <div className="container-fluid">
        <div className="row">
          <div className="col-lg-12 mt-5">
            <h1 className="heading">Decor Products</h1>
          </div>
        </div>
      </div>
        ...
        <div className="row">
          <div className="col-lg-4">
            <select onChange={(e) => setCategory(e.target.value)}>
              <option value="all">Decor Category</option>
              <option value="C1">Rugs and Carpets</option>
              <option value="C2">Curtains and Blinds</option>
              <option value="C3">Wall Art and Mirrors</option>
              <option value="C4">Cushions and Throws</option>
              <option value="C5">Vases and Plant Pots</option>
            </select>
          </div>
