...
import data from './assets/js/Furniture';
      ...
      <div className="container-fluid">
          <div className="row">
            <div className="col-lg-12 mt-5">
              <h1 className="heading">Furniture Products</h1>
            </div>
          </div>
        </div>
        ...
        <div className="row">
          <div className="col-lg-4">
            <select onChange={(e) => setCategory(e.target.value)}>
              <option value="all">Furniture Category</option>
              <option value="C1">Sofas and Couches</option>
              <option value="C5">Tables</option>
              <option value="C2">Beds and Mattresses</option>
              <option value="C3">Chairs and Recliners</option>
              <option value="C4">Storage</option>
            </select>
          </div>
          ...
          {filteredData.map((item) => (
            <div className="col-lg-4 p-3" key={item.id}>
              <div className="product-card">
                <img src={item.img} alt={item.name} width="100%" height="400px" />
