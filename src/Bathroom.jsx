...
import data from './assets/js/bathroom'; // Your bathroom data source
      ...
      <div className="container-fluid">
        <div className="row">
          <div className="col-lg-12 mt-5">
            <h1 className="heading">Bathroom Products</h1>
          </div>
        </div>
      </div>
        ...
        <div className="row">
          <div className="col-lg-4">
            <select onChange={(e) => setCategory(e.target.value)}>
              <option value="all">Bathroom Category</option>
              <option value="C1">Vanities</option>
              <option value="C2">Shower Fixtures</option>
              <option value="C3">Mirrors</option>
              <option value="C4">Bath Accessories</option>
              <option value="C5">Toilets</option>
            </select>
          </div>
